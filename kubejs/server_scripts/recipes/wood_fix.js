ServerEvents.recipes((e) => {
	...
	let stripWood = (output, input) => {
		e.recipes.create.cutting(Item.of(output), input);
	};

	// new code
	let strippedToPlanks = (output, input) => {
		e.recipes.create.cutting(Item.of(output, 6), input);
	};
	...
	strippedToPlanks(
		"extendedmushrooms:glowshroom_planks",
		"extendedmushrooms:glowshroom_stem_stripped"
	);
	strippedToPlanks(
		"extendedmushrooms:poisonous_mushroom_planks",
		"extendedmushrooms:poisonous_mushroom_stem_stripped"
	);
	strippedToPlanks(
		"extendedmushrooms:honey_fungus_planks",
		"extendedmushrooms:honey_fungus_stem_stripped"
	);
	strippedToPlanks(
		"extendedmushrooms:mushroom_planks",
		"extendedmushrooms:stripped_mushroom_stem"
	);

	e.recipes.create.cutting(
		[
			"extradelight:stripped_cinnamon_log",
			Item.of("extradelight:cinnamon_bark", 2),
			Item.of("extradelight:cinnamon_bark", 2).withChance(0.25),
		],
